...
class ComponentFactory {
    ...
    columns(element) {
        ...
        let colCount = util_1.Adapter.getChildNodes(element).length;
    ...
    button(element) {
        ...
        let { href, target, class: cls } = attrs, parentAttrs = __rest(attrs, ["href", "target", "class"]);
        let expander = '';
    ...
    menuItem(element) {
        ...
        let { href, target } = attrs, parentAttrs = __rest(attrs, ["href", "target"]);
        return `
